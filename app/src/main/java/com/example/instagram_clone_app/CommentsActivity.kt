...
import com.example.instagram_clone_app.Adapter.CommentAdapter
...
class CommentsActivity : AppCompatActivity()
{
    ...
    private var commentList: MutableList<com.example.instagram_clone_app.Model.Comment>? = null
        ...
        commentsRef.addValueEventListener(object : ValueEventListener
        {
            override fun onDataChange(p0: DataSnapshot)
            {
                if (p0.exists())
                {
                    ...
                    {
                        val comment = snapshot.getValue(com.example.instagram_clone_app.Model.Comment::class.java)
