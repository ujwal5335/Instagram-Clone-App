    ...
    private fun updateUserInfoOnly()
    {
        when {
            ...
            bio_profile_frag.text.toString() == "" -> Toast.makeText(this, "Please write your bio first.", Toast.LENGTH_LONG).show()
                ...
                userMap["fullname"] = full_name_profile_frag.text.toString().lowercase(Locale.ROOT)
                userMap["username"] = username_profile_frag.text.toString().lowercase(Locale.ROOT)
                userMap["bio"] = bio_profile_frag.text.toString().lowercase(Locale.ROOT)
